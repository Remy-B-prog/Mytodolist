    ...
    if (modal && window.innerWidth <= 1024) {
        return (
            <div className='flex justify-center w-full h-full backdrop-blur-sm fixed'>
                <div className={`bg-pink w-3/4 h-3/4 md:w-3/5 md:h-3/5 rounded-lg mt-10 md:mt-32 border-2 border-black ${filteredTask.category === 'Taches ménagère' ? "bg-yellow" : "bg-pink"}`} >
                    <div
